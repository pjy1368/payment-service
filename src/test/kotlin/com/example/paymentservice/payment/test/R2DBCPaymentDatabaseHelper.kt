      ...
      .flatMap { groupedFlux ->
        groupedFlux.collectList().map { results ->
          PaymentEvent(
            ...
            paymentType = if (results.first()["type"] != null) PaymentType.valueOf(results.first()["type"] as String) else null,
            ...
            paymentOrders = results.map { result ->
              PaymentOrder(
                ...
                paymentStatus = PaymentStatus.valueOf(result["payment_order_status"] as String),
